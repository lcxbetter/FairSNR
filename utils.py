...
def get_enc_cls_opt(args):
    ...
    Intervenor = Intervenor_encoder(args).to(args.device)
    optimizer_i = torch.optim.Adam([
        dict(params=Intervenor.parameters(), weight_decay=args.i_wd)], lr=args.i_lr)
    ...
    return encoder, classifier,Intervenor, optimizer_e, optimizer_c,optimizer_i
